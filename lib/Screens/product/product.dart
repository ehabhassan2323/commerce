...
Widget buildProduct( ProductsModel? model  , context,) {

  return InkWell(
    onTap: ()
    {
      navigateToPush(context , ProductDetails( model!),
      );
    },
    child: Padding(
        ...
        child: Column(
          children:[
            ...
            TextButton(
              ...
              child: Text('Oder it', style: TextStyle(fontSize: 17,color: defaultColor),),
